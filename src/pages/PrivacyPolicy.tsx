/**
 * Privacy Policy Page
 * GCC-Compliant Privacy Policy for G2 Middle East
 */
  ...
  return (
    <div class="min-h-screen bg-g2-darker">
        ...
        <div class="max-w-7xl mx-auto px-6 py-5">
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-6">
              <a href="/" class="text-sm text-gray-300 hover:text-white transition-colors flex items-center gap-2">
      ...
      <div class="max-w-4xl mx-auto px-6 py-16">
        ...
        <div class="mb-12">
          <div class="mb-4">
            <span class="text-g2-gold text-xs font-semibold uppercase tracking-widest">Legal</span>
          </div>
          <h1 class="text-5xl font-serif font-bold text-white mb-6 tracking-wide">
            Privacy Policy
          </h1>
        ...
        {/* Table of Contents */}
        <div class="bg-g2-dark/60 border border-white/10 rounded-2xl p-8 mb-12">
          <h2 class="text-xl font-serif font-bold text-white mb-6">Table of Contents</h2>
          <nav class="space-y-3">
            <a href="#introduction" class="block text-g2-gold hover:text-white transition-colors">1. Introduction</a>
            <a href="#data-controller" class="block text-g2-gold hover:text-white transition-colors">2. Data Controller Information</a>
            <a href="#data-collection" class="block text-g2-gold hover:text-white transition-colors">3. Information We Collect</a>
            <a href="#how-we-use" class="block text-g2-gold hover:text-white transition-colors">4. How We Use Your Information</a>
            <a href="#legal-basis" class="block text-g2-gold hover:text-white transition-colors">5. Legal Basis for Processing</a>
            <a href="#data-sharing" class="block text-g2-gold hover:text-white transition-colors">6. Data Sharing and Disclosure</a>
            <a href="#data-security" class="block text-g2-gold hover:text-white transition-colors">7. Data Security</a>
            <a href="#data-retention" class="block text-g2-gold hover:text-white transition-colors">8. Data Retention</a>
            <a href="#your-rights" class="block text-g2-gold hover:text-white transition-colors">9. Your Rights</a>
            <a href="#cookies" class="block text-g2-gold hover:text-white transition-colors">10. Cookies and Tracking</a>
            <a href="#international-transfers" class="block text-g2-gold hover:text-white transition-colors">11. International Data Transfers</a>
            <a href="#children" class="block text-g2-gold hover:text-white transition-colors">12. Children's Privacy</a>
            <a href="#gcc-compliance" class="block text-g2-gold hover:text-white transition-colors">13. GCC-Specific Compliance</a>
            <a href="#changes" class="block text-g2-gold hover:text-white transition-colors">14. Changes to This Policy</a>
            <a href="#contact" class="block text-g2-gold hover:text-white transition-colors">15. Contact Us</a>
          </nav>
        </div>
        ...
        <div class="prose prose-invert prose-lg max-w-none space-y-12">
          ...
          <section id="introduction">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">1.</span> Introduction
            </h2>
          ...
          <section id="data-controller">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">2.</span> Data Controller Information
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <p>
                G2 Middle East is the data controller responsible for your personal information.
              </p>
              <div class="bg-g2-dark/60 border border-white/10 rounded-xl p-6 space-y-3">
                <p><strong class="text-white">Contact Information:</strong></p>
                <p>Email: <a href="mailto:privacy@g2middleeast.com" class="text-g2-gold hover:text-white underline">privacy@g2middleeast.com</a></p>
                <p>Data Protection Officer: <a href="mailto:dpo@g2middleeast.com" class="text-g2-gold hover:text-white underline">dpo@g2middleeast.com</a></p>
              </div>
            </div>
          </section>
          ...
          <section id="data-collection">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">3.</span> Information We Collect
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">3.1 Information You Provide</h3>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">3.2 Automatically Collected Information</h3>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">3.3 Cookies and Tracking Technologies</h3>
              <p>
          ...
          <section id="how-we-use">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">4.</span> How We Use Your Information
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <p>We use your personal information for the following purposes:</p>
              
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">4.1 Service Provision</h3>
              <ul class="list-disc list-inside space-y-2 ml-4">
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">4.2 Security and Compliance</h3>
              <ul class="list-disc list-inside space-y-2 ml-4">
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">4.3 Communication</h3>
              <ul class="list-disc list-inside space-y-2 ml-4">
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">4.4 Analytics and Improvement</h3>
              <ul class="list-disc list-inside space-y-2 ml-4">
          ...
          <section id="legal-basis">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">5.</span> Legal Basis for Processing
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
          ...
          <section id="data-sharing">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">6.</span> Data Sharing and Disclosure
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">6.1 We Do NOT Sell Your Data</h3>
              <p>
                We do not sell, rent, or trade your personal information to third parties for their marketing purposes.
              </p>

              <h3 class="text-xl font-semibold text-white mt-6 mb-3">6.2 Sharing with Service Providers</h3>
              <p>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">6.3 Legal Disclosures</h3>
              <p>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">6.4 Business Transfers</h3>
              <p>
          ...
          <section id="data-security">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">7.</span> Data Security
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">7.1 Security Measures</h3>
              <p>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">7.2 Your Responsibility</h3>
              <p>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">7.3 Data Breach Notification</h3>
              <p>
          ...
          <section id="data-retention">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">8.</span> Data Retention
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <p>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">8.1 Retention Periods</h3>
              <ul class="list-disc list-inside space-y-2 ml-4">
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">8.2 Deletion Process</h3>
              <p>
          ...
          <section id="your-rights">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">9.</span> Your Rights
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <p>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">9.1 Right to Access</h3>
              <p>
                You can request a copy of the personal information we hold about you.
              </p>

              <h3 class="text-xl font-semibold text-white mt-6 mb-3">9.2 Right to Rectification</h3>
              <p>
                You can request correction of inaccurate or incomplete information.
              </p>

              <h3 class="text-xl font-semibold text-white mt-6 mb-3">9.3 Right to Erasure ("Right to be Forgotten")</h3>
              <p>
                You can request deletion of your personal information, subject to legal retention requirements.
              </p>

              <h3 class="text-xl font-semibold text-white mt-6 mb-3">9.4 Right to Restrict Processing</h3>
              <p>
                You can request limitation of how we process your information in certain circumstances.
              </p>

              <h3 class="text-xl font-semibold text-white mt-6 mb-3">9.5 Right to Data Portability</h3>
              <p>
                You can request your data in a structured, machine-readable format.
              </p>

              <h3 class="text-xl font-semibold text-white mt-6 mb-3">9.6 Right to Object</h3>
              <p>
                You can object to processing based on legitimate interests or for marketing purposes.
              </p>

              <h3 class="text-xl font-semibold text-white mt-6 mb-3">9.7 Right to Withdraw Consent</h3>
              <p>
                Where processing is based on consent, you can withdraw it at any time.
              </p>

              <h3 class="text-xl font-semibold text-white mt-6 mb-3">9.8 How to Exercise Your Rights</h3>
              <p>
                To exercise any of these rights, contact us at <a href="mailto:privacy@g2middleeast.com" class="text-g2-gold hover:text-white underline">privacy@g2middleeast.com</a>. We will respond within 30 days of receiving your request.
              </p>
            </div>
          </section>
          ...
          <section id="cookies">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">10.</span> Cookies and Tracking Technologies
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">10.1 What Are Cookies?</h3>
              <p>
                Cookies are small text files stored on your device that help us provide and improve our services.
              </p>

              <h3 class="text-xl font-semibold text-white mt-6 mb-3">10.2 Types of Cookies We Use</h3>
              <ul class="list-disc list-inside space-y-2 ml-4">
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">10.3 Cookie Duration</h3>
              <ul class="list-disc list-inside space-y-2 ml-4">
                <li><strong>Session Cookies:</strong> Deleted when you close your browser</li>
                <li><strong>Persistent Cookies:</strong> Remain for up to 30 days (authentication) or 1 year (preferences)</li>
              </ul>

              <h3 class="text-xl font-semibold text-white mt-6 mb-3">10.4 Managing Cookies</h3>
              <p>
          ...
          <section id="international-transfers">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">11.</span> International Data Transfers
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <p>
          ...
          <section id="children">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">12.</span> Children's Privacy
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <p>
          ...
          <section id="gcc-compliance">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">13.</span> GCC-Specific Compliance
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <p>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">13.1 United Arab Emirates</h3>
              <ul class="list-disc list-inside space-y-2 ml-4">
                <li>Federal Law No. 45 of 2021 on Personal Data Protection</li>
                <li>UAE Data Office: <a href="https://u.ae/en/about-the-uae/digital-uae/data/data-protection" class="text-g2-gold hover:text-white underline" target="_blank">u.ae/data-protection</a></li>
              </ul>

              <h3 class="text-xl font-semibold text-white mt-6 mb-3">13.2 Saudi Arabia</h3>
              <ul class="list-disc list-inside space-y-2 ml-4">
                <li>Personal Data Protection Law (PDPL)</li>
                <li>Saudi Data & AI Authority (SDAIA)</li>
              </ul>

              <h3 class="text-xl font-semibold text-white mt-6 mb-3">13.3 Qatar</h3>
              <ul class="list-disc list-inside space-y-2 ml-4">
                <li>Law No. 13 of 2016 on Personal Data Privacy Protection</li>
              </ul>

              <h3 class="text-xl font-semibold text-white mt-6 mb-3">13.4 Other GCC Countries</h3>
              <p>
          ...
          <section id="changes">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">14.</span> Changes to This Privacy Policy
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <p>
          ...
          <section id="contact">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">15.</span> Contact Us
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <p>
              ...
              <div class="bg-g2-dark/60 border border-white/10 rounded-xl p-6 space-y-3">
                <p><strong class="text-white">Privacy Contact:</strong></p>
                <p>Email: <a href="mailto:privacy@g2middleeast.com" class="text-g2-gold hover:text-white underline">privacy@g2middleeast.com</a></p>
                <p>Data Protection Officer: <a href="mailto:dpo@g2middleeast.com" class="text-g2-gold hover:text-white underline">dpo@g2middleeast.com</a></p>
                <p>General Inquiries: <a href="mailto:contact@g2middleeast.com" class="text-g2-gold hover:text-white underline">contact@g2middleeast.com</a></p>
              </div>
        ...
        {/* Footer CTA */}
        <div class="mt-16 p-8 bg-g2-dark/60 border border-white/10 rounded-2xl text-center">
          <p class="text-gray-300 mb-6">
            By using our services, you acknowledge that you have read and understood this Privacy Policy.
          </p>
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/projects/register" class="px-8 py-3 bg-g2-gold text-g2-darker font-semibold rounded-lg hover:bg-opacity-90 transition-all">
              Register for Access
            </a>
            <a href="/terms-of-service" class="px-8 py-3 bg-g2-darker border border-white/20 text-white font-semibold rounded-lg hover:bg-white/5 transition-all">
