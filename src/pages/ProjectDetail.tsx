...
export const projectsData = {
  ...
  'chanel-princess-dubai-brand-architecture': {
    ...
    engagingParagraph: `<p class="mb-4">In the saturated world of digital luxury, influence is a commodity. Authority, however, is an enduring asset. This project was an exercise in pure strategic positioning—transforming a world-class private fashion collection from personal passion into a globally recognized cultural institution. The challenge wasn't building a following; millions were already captivated by the passion and the pieces. Our task was to architect a narrative that could translate that following into unassailable, institutional-level authority. This wasn't a marketing campaign. It was the construction of a new fashion paradigm.</p>
    
    <p class="mb-4">Our approach began with a fundamental premise: true influence in the luxury space isn't derived from promotion, but from education. We advised a strategic pivot away from the conventional influencer model of commercial endorsements, and toward a framework of rigorous, museum-quality curation. The core of our strategy was building what we termed a "distributed museum"—a living, breathing archive that could operate with the intellectual heft of a traditional institution, but with the speed and accessibility of a digital platform.</p>
    
    <p class="mb-4">We reframed the collection—over 1,300 pieces of Chanel, with an unprecedented 30% classified as rare—not as a wardrobe, but as a cultural asset. Each Instagram post became a curatorial act. Captions evolved into micro-essays, detailing the historical context of a garment, the provenance of a piece of jewelry, or the evolution of specific hardware designs. This "museum-to-muse" model transformed passive viewing into active learning, building a deep trust premium with an audience hungry for substance in a landscape defined by superficiality.</p>
    
    <p class="mb-4">This educational framework became the foundation for a new kind of value creation. By establishing the platform as the preeminent source of Chanel knowledge, we cultivated what the market now recognizes as a measurable impact: pieces featured consistently experience 15-30% appreciation in secondary luxury markets within 6-12 months. This quantifiable effect is the ultimate validation of our strategy. The authority we architected now carries the same market-moving weight as a major museum acquisition or a feature in a legacy fashion publication.</p>
    
    <p class="mb-4">We also leveraged Dubai's unique geographic advantage. Operating outside the rigid hierarchies of traditional fashion capitals like Paris or Milan allowed us to innovate freely. Dubai became the perfect incubator for this new model of cultural authority—a place where expertise and strategic vision could build an institution from the ground up, unencumbered by legacy systems or gatekeepers.</p>
    
    <p class="mb-4">The result is a complete paradigm shift. What began as digital influence has evolved into the world's leading independent authority on Chanel—an educator and market-maker whose curatorial choices shape the collecting habits of a generation. The platform now serves as a primary resource for academics, designers, and collectors worldwide, demonstrating that authority built on knowledge transcends geography and traditional hierarchies.</p>
    
    <p>This project exemplifies G2's core philosophy: The Architecture of Intangible Value. We didn't simply manage a brand; we built an institution. By focusing on narrative depth, educational rigor, and strategic positioning, we transformed private passion into public authority—proving that in the modern world, the most powerful assets aren't just seen, but deeply understood.</p>`,
    supportingImages: [
      {
