...
export const projectsData = {
  ...
  'chanel-princess-dubai-brand-architecture': {
    ...
    <p class="mb-4">In the saturated world of digital luxury, influence is a commodity. Authority, however, is an asset. Our engagement with Lee Davies, the collector behind the globally renowned @chanelprincessdubai platform, was an exercise in pure strategic positioning. The challenge was not to build a following; the passion and the pieces had already attracted millions, but to architect a narrative that could translate that following into unassailable, institutional level authority. This was not a marketing campaign; it was the construction of a new fashion paradigm.</p>
    
    <p class="mb-4">Our approach began with a fundamental premise: true influence in the luxury space is not derived from promotion, but from education. We advised a strategic pivot away from the conventional influencer model of commercial endorsements and towards a framework of rigorous, museum quality curation. The core of our strategy was to build what we termed a "distributed museum," a living, breathing archive that could operate with the intellectual heft of a traditional institution but with the speed and accessibility of a digital platform.</p>
    
    <p class="mb-4">We worked to frame the collection, over 1,300 pieces of Chanel, with an unprecedented 30% classified as rare, not as a wardrobe, but as a cultural asset. Each Instagram post was repositioned to be a curatorial act. Captions became micro essays, detailing the historical context of a garment, the provenance of a piece of jewellery, or the evolution of a specific hardware design. This "museum to muse" model transformed passive viewing into active learning, building a deep "trust premium" with an audience that was hungry for substance in a landscape defined by superficiality.</p>
    
    <p class="mb-4">This educational framework became the foundation for a new kind of value creation. By establishing @chanelprincessdubai as the preeminent source of knowledge, we cultivated what the market now recognizes as the "Davies Effect." Pieces featured on the platform consistently experience a 15-30% appreciation in the secondary luxury markets within 6-12 months. This quantifiable impact is the ultimate proof of the strategy's success: the authority we architected now carries the same market moving weight as a major museum acquisition or a feature in a legacy fashion publication.</p>
    
    <p class="mb-4">Furthermore, we leveraged the unique geographic advantage of Dubai. Operating outside the rigid hierarchies of traditional fashion capitals like Paris or Milan allowed us to innovate. Dubai became the perfect incubator for this new model of cultural authority, a place where expertise and strategic vision could create an institution from the ground up, unencumbered by legacy systems.</p>
    
    <p class="mb-4">The result is a complete paradigm shift. Lee Davies is no longer just an influencer; she is ranked the #1 Chanel authority globally, an educator, and a market maker whose curatorial choices shape the collecting habits of a generation. Her platform serves as a primary resource for academics, designers, and collectors alike.</p>
    
    <p>This project is a definitive case study in G2's core philosophy: The Architecture of Intangible Value. We did not simply manage a brand; we built an institution. By focusing on narrative, education, and strategic positioning, we transformed private passion into public authority, demonstrating that in the modern world, the most powerful assets are not just seen, but understood.</p>`,
    supportingImages: [
      {
