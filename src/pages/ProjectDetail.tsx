    ...
    'qatar-olympic-house': {
      ...
      "@graph": [
        ...
        },
        {
          ...
          "image": {
            "@type": "ImageObject",
            "url": "https://page.gensparksite.com/v1/base64_upload/578b7cc60a498b8e501f67ae6988aebaHero",
...
export const projectsData = {
  ...
  'queen-elizabeth-ii-state-visit': {
    ...
    engagingParagraph: `<p class="mb-4">A sovereign state visit is more than a series of events; it is a complex diplomatic ballet where every detail carries the weight of national reputation. In 2010, the United Arab Emirates welcomed Her Majesty Queen Elizabeth II for a landmark visit, an occasion that demanded nothing less than absolute perfection. The challenge was immense: to design and execute eight distinct, high-protocol events within a compressed 20-hour timeline, seamlessly blending the centuries-old traditions of the British monarchy with the ambitious vision of the UAE. An individual with a unique mastery of logistics, protocol, and crisis management was required to lead this monumental undertaking. That individual was Tim Jacobs.</p>
    
    <h3 class="text-2xl font-bold text-white mb-4 mt-8">The Architect: Tim Jacobs and His Personal Blueprint for Diplomatic Success</h3>
    <p class="mb-4">As the appointed Project Director, Tim Jacobs was the central mind responsible for the visit's overall success. He didn't just manage the project; he personally architected the strategic framework that ensured its flawless execution. His success was built on a methodology forged over a career of leading high-stakes global engagements, a methodology that is now foundational to the G2 Middle East & Africa approach.</p>
    
    <p class="mb-4">Three pillars of his personal strategy were critical:</p>
    
    <p class="mb-4"><strong>Unified Stakeholder Command:</strong> Jacobs personally devised and implemented a centralized command structure. This integrated the complex requirements of the UAE Federal Government, Buckingham Palace, royal security details, and global media into a single, agile operational workflow. His hands-on leadership eliminated silos and ensured every one of the dozens of teams involved moved with a unified purpose.</p>
    
    <p class="mb-4"><strong>Meticulous Protocol Integration:</strong> The visit required a deep understanding of the nuanced protocols of two distinct sovereign entities. Jacobs personally oversaw the meticulous planning of every detail, from motorcade logistics and security formations to the intricate event flows for press conferences and the spectacular launch of the Zayed National Museum. His expertise ensured that cultural respect and diplomatic precision were at the heart of every decision.</p>
    
    <p class="mb-4"><strong>Agile, High-Pressure Execution:</strong> With a 20-hour window to deliver seven primary events, there was no margin for error or delay. Jacobs deployed a uniquely agile project management approach, enabling his teams to design and build bespoke event structures and navigate immense logistical challenges under extreme time pressure. This ability to deliver creative and technical excellence against an unforgiving deadline was a testament to his crisis-tested leadership.</p>
    
    <h3 class="text-2xl font-bold text-white mb-4 mt-8">The Landmark Result: A Testament to Individual Excellence</h3>
    <p class="mb-4">Under Tim Jacobs's personal direction, the state visit was executed flawlessly. It was a resounding success, celebrated globally as an affirmation of the deep friendship between two great nations. More than just a series of perfectly managed events, the visit showcased the UAE's world-class capability in hosting engagements of the highest global importance, solidifying its reputation for operational excellence.</p>
    
    <h3 class="text-2xl font-bold text-white mb-4 mt-8">The G2 Advantage: Accessing This Proven Mastery</h3>
    <p class="mb-4">The strategic mind, surgical precision, and unshakeable leadership that Tim Jacobs demonstrated in delivering this historic state visit are the same qualities that now drive G2 Middle East & Africa. As Regional COO, his personal methodology for transforming impossible challenges into landmark successes is embedded in our DNA. Clients of G2 do not just hire an agency; they gain direct access to the proven architect behind some of the most complex and successful sovereign events in modern history.</p>`,
    supportingImages: [
      {
  ...
  'qatar-olympic-house': {
    ...
    year: '2012',
    heroImage: 'https://page.gensparksite.com/v1/base64_upload/578b7cc60a498b8e501f67ae6988aebaHero',
