 ...
 * GCC-Compliant Terms for G2 Middle East Projects Portal
 */
    ...
    <div class="min-h-screen bg-g2-darker">
      ...
      <div class="max-w-4xl mx-auto px-6 py-16">
        ...
        <div class="bg-g2-dark/60 border border-white/10 rounded-2xl p-8 mb-12">
          ...
          <nav class="space-y-3">
            <a href="#acceptance" class="block text-g2-gold hover:text-white transition-colors">1. Acceptance of Terms</a>
            <a href="#eligibility" class="block text-g2-gold hover:text-white transition-colors">2. Eligibility and Account Registration</a>
            <a href="#use-license" class="block text-g2-gold hover:text-white transition-colors">3. Use License and Restrictions</a>
            <a href="#confidentiality" class="block text-g2-gold hover:text-white transition-colors">4. Confidentiality and Non-Disclosure</a>
            <a href="#intellectual-property" class="block text-g2-gold hover:text-white transition-colors">5. Intellectual Property Rights</a>
            <a href="#prohibited-conduct" class="block text-g2-gold hover:text-white transition-colors">6. Prohibited Conduct</a>
            <a href="#data-protection" class="block text-g2-gold hover:text-white transition-colors">7. Data Protection and Privacy</a>
            <a href="#termination" class="block text-g2-gold hover:text-white transition-colors">8. Termination</a>
            <a href="#disclaimers" class="block text-g2-gold hover:text-white transition-colors">9. Disclaimers and Limitations</a>
            <a href="#indemnification" class="block text-g2-gold hover:text-white transition-colors">10. Indemnification</a>
            <a href="#governing-law" class="block text-g2-gold hover:text-white transition-colors">11. Governing Law and Dispute Resolution</a>
            <a href="#amendments" class="block text-g2-gold hover:text-white transition-colors">12. Amendments</a>
            <a href="#contact" class="block text-g2-gold hover:text-white transition-colors">13. Contact Information</a>
          </nav>
        </div>
        ...
        <div class="prose prose-invert prose-lg max-w-none space-y-12">
          ...
          <section id="acceptance">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">1.</span> Acceptance of Terms
            </h2>
          ...
          <section id="eligibility">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">2.</span> Eligibility and Account Registration
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">2.1 Eligibility Requirements</h3>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">2.2 Account Registration</h3>
              <p>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">2.3 Account Approval</h3>
              <p>
          ...
          <section id="use-license">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">3.</span> Use License and Restrictions
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">3.1 Limited License</h3>
              <p>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">3.2 Restrictions</h3>
              <p>You may NOT:</p>
              <ul class="list-disc list-inside space-y-2 ml-4">
          ...
          <section id="confidentiality">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">4.</span> Confidentiality and Non-Disclosure
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">4.1 Confidential Information</h3>
              <p>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">4.2 Non-Disclosure Obligations</h3>
              <p>You agree to:</p>
              <ul class="list-disc list-inside space-y-2 ml-4">
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">4.3 Breach Consequences</h3>
              <p>
          ...
          <section id="intellectual-property">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">5.</span> Intellectual Property Rights
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">5.1 Ownership</h3>
              <p>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">5.2 Trademarks</h3>
              <p>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">5.3 No Transfer of Rights</h3>
              <p>
          ...
          <section id="prohibited-conduct">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">6.</span> Prohibited Conduct
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
          ...
          <section id="data-protection">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">7.</span> Data Protection and Privacy
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">7.1 Privacy Policy</h3>
              <p>
                Our collection, use, and protection of your personal data is governed by our <a href="/privacy-policy" class="text-g2-gold hover:text-white underline">Privacy Policy</a>, which is incorporated into these Terms by reference.
              </p>

              <h3 class="text-xl font-semibold text-white mt-6 mb-3">7.2 GCC Compliance</h3>
              <p>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">7.3 Data Security</h3>
              <p>
          ...
          <section id="termination">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">8.</span> Termination
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">8.1 Termination by You</h3>
              <p>
                You may terminate your account at any time by contacting us at <a href="mailto:contact@g2middleeast.com" class="text-g2-gold hover:text-white underline">contact@g2middleeast.com</a>.
              </p>

              <h3 class="text-xl font-semibold text-white mt-6 mb-3">8.2 Termination by Us</h3>
              <p>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">8.3 Effect of Termination</h3>
              <p>
          ...
          <section id="disclaimers">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">9.</span> Disclaimers and Limitations of Liability
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">9.1 "AS IS" Basis</h3>
              <p>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">9.2 No Guarantee</h3>
              <p>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">9.3 Limitation of Liability</h3>
              <p>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">9.4 Cap on Liability</h3>
              <p>
          ...
          <section id="indemnification">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">10.</span> Indemnification
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <p>
          ...
          <section id="governing-law">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">11.</span> Governing Law and Dispute Resolution
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">11.1 Governing Law</h3>
              <p>
              ...
              <h3 class="text-xl font-semibold text-white mt-6 mb-3">11.2 Dispute Resolution</h3>
              <p>
          ...
          <section id="amendments">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">12.</span> Amendments and Modifications
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <p>
          ...
          <section id="contact">
            <h2 class="text-3xl font-serif font-bold text-white mb-6 flex items-center gap-3">
              <span class="text-g2-gold">13.</span> Contact Information
            </h2>
            <div class="text-gray-300 leading-relaxed space-y-4">
              <p>
              ...
              <div class="bg-g2-dark/60 border border-white/10 rounded-xl p-6 space-y-3">
                <p><strong class="text-white">G2 Middle East</strong></p>
                <p>Email: <a href="mailto:legal@g2middleeast.com" class="text-g2-gold hover:text-white underline">legal@g2middleeast.com</a></p>
        ...
        <div class="mt-16 p-8 bg-g2-dark/60 border border-white/10 rounded-2xl text-center">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="/privacy-policy" class="px-8 py-3 bg-g2-darker border border-white/20 text-white font-semibold rounded-lg hover:bg-white/5 transition-all">
              View Privacy Policy
            </a>
          </div>
        </div>
